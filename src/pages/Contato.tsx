...
import { Shield, ArrowRight, Mail, User, Building2, MessageSquare, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-24">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          {submitted ? (
            <div className="gradient-card rounded-xl border border-primary/30 p-12 text-center space-y-4">
              <CheckCircle className="h-12 w-12 text-primary mx-auto" />
              <h2 className="text-xl font-bold">Mensagem recebida!</h2>
            ...
            <form onSubmit={handleSubmit} className="gradient-card rounded-xl border border-border p-8 space-y-6">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full inline-flex items-center justify-center gap-2 rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:brightness-110 disabled:opacity-50"
              >
